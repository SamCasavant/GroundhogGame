...
def worldInit():
    ...
    green_onions = things.Food(
        "Green Onions", "Like red onions, but greener.", tags=["take", "eat"]
    )
    cut_green_onions = things.Food(
        "Green Onions", "All prepared.", tags=["take", "eat"]
    )

    red_cabbage = things.Food(
        "Red Cabbage", "It's actually purple.", tags=["take", "eat"]
    )
    green_cabbage = things.Food(
        "Green Cabbage", "It's not easy being green cabbage.", tags=["take", "eat"]
    )
    cabbage_mix = things.Food("Cabbage Mix", "My cabbages!", tags=["take", "eat"])

    uncooked_rice_noodles = things.Food(
        "Uncooked Rice Noodles", "Gotta cook these.", tags=["take", "eat"]
    )
    rice_noodles = things.Food(
        "Rice Noodles", "The worst noodles.", tags=["take", "eat"]
    )
