...
impl GameTime {
    ...
    pub fn copy_and_tick(&self, seconds: u32) -> GameTime{ //Produces a new time instance at a later point for scheduling relative to self
        GameTime{ raw: &self.raw + seconds }
    }
}
